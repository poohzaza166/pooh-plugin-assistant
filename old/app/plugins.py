...
class PluginManager:
    ...
    def __init__(self, plugin_folder: str, parser: UnifiedCommandParser, api: FastAPI):
    ...
    def _load_plugin(self, plugin_name: str):
        # try:
            ...
            if hasattr(plugin_module, 'plugin_entry'):
                plugin_instance = plugin_module.plugin_entry(self.message_bus, self.parser, self.api)
